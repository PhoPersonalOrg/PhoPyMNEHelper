...
def _autoreject_bad_sample_mask(raw: mne.io.BaseRaw, epochs: mne.Epochs, reject_log: Any) -> np.ndarray:
        ...
        try:
            ...
            if len(epochs) < 2:
                ...
                try:
                    ...
                    del _epochs_clean
                    ar_mask = _autoreject_bad_sample_mask(raw, epochs, reject_log)
